...
function addStation() {
  ...
  DivAir.innerHTML =
    '<img class="img_plane" src="/asses/favicon/airplane.svg"/>';
  // Dong thong tin
  ...
  DivSign.innerHTML =
    '<button id="remove-' +
    i +
    '" class="btn_substract_sign" ><svg xmlns="http://www.w3.org/2000/svg" width="25" height="29" viewBox="0 0 448 512"><path d="M432 256c0 17.7-14.3 32-32 32L48 288c-17.7 0-32-14.3-32-32s14.3-32 32-32l352 0c17.7 0 32 14.3 32 32z"/></svg></button>';
